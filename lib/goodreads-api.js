...
var Goodreads = function Goodreads(credentials, callbackURL) {
  ...
  */
  function getUsersShelves(id) {
    return new Promise(function (resolve, reject) {
      ...
      var req = Request.builder().withPath(path).withQueryParams(options).withResponseKey('shelves').build();
  ...
  */
  function createComment(type, id, comment) {
    if (!OAUTH) return noOAuthError('createComment()');
  ...
  */
  function getReadStatus(id) {
    ...
    var req = Request.builder().withPath(path).withQueryParams(options).withResponseKey('read_status').build();
  ...
  */
  function getBooksOnUserShelf(id, shelf, queryOptions) {
    ...
    var req = Request.builder().withPath(path).withResponseKey('reviews').withQueryParams(options).withOAuth(authOptions).build();
  ...
  */
  ...
  return {
    initOAuth: initOAuth, //works
    getRequestToken: getRequestToken, //works
    getAccessToken: getAccessToken, //works
    getBooksByAuthor: getBooksByAuthor, //works
    getAuthorInfo: getAuthorInfo, //works
    getAllSeriesByAuthor: getAllSeriesByAuthor, //works
    getRecentStatuses: getRecentStatuses, //works
    getBooksOnUserShelf: getBooksOnUserShelf, //works
    getUsersReviewForBook: getUsersReviewForBook, //works
    getUserStatus: getUserStatus, //works
    getUserInfo: getUserInfo, //works
    getRecentReviews: getRecentReviews, //works
    getReview: getReview, //works
    addBookToShelf: addBookToShelf, //works
    getOwnedBooks: getOwnedBooks, //works
    searchBooks: searchBooks, //works
    searchAuthors: searchAuthors, //works
    followAuthor: followAuthor, //works
    unfollowAuthor: unfollowAuthor, //works
    showFollowing: showFollowing, //works
